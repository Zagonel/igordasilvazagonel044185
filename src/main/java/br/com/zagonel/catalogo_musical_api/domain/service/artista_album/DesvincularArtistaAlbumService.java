package br.com.zagonel.catalogo_musical_api.domain.service.artista_album;
...
public class DesvincularArtistaAlbumService {
    ...
    public void execute(UUID albumUuid, UUID artistaUuid) {
        ...
        albumDomain.desvincularArtista(artista.getId());
        artista.desvincularAlbum(albumDomain.getId());
